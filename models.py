...
class NearEarthObject:
    ...
    def __init__(self, pdes, name, diameter, hazardous):
        """Create a new `NearEarthObject`.

        :param info: pdes is mandatory argument, other keyword arguments are optional .
        """
    ...
    def serialize(self, format="json"):
        """
        create serialization format for storing the object
        """
        if format == "json":
            return {
            ...
            return {
                ...
                "diameter_km": self.diameter if self.diameter != 0.0 else "",
                "potentially_hazardous": self.hazardous,
            }

    def __str__(self):
        """Return `str(self)`."""
        return f"NEO {self.fullname} has a diameter of {self.diameter} and {'is' if self.hazardous else 'is not'} potentially hazardous."
...
class CloseApproach:
    ...
    def __init__(self, neo, designation, time, distance, velocity):
